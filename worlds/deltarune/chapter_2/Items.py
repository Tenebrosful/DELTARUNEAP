...
chapter2_items = {
  ...
  CCItems.dark_dollars_250.value: ItemData(ItemIDs.dark_dollars_250.value,  ItemClassification.useful),
  
  CCItems.clubsSandwich.value:      ItemData(ItemIDs.clubsandwich.value,      ItemClassification.useful),
  Ch2Items.joe_life_savings.value:  ItemData(ItemIDs.joe_life_savings.value,  ItemClassification.useful),
  ...
  Ch2Items.fiberscarf.value:        ItemData(ItemIDs.fiberscarf.value,        ItemClassification.useful),
  Ch2Items.ragger2.value:           ItemData(ItemIDs.ragger2.value,           ItemClassification.useful),
  Ch2Items.bounceblade.value:       ItemData(ItemIDs.bounceblade.value,       ItemClassification.useful),
  
  Ch2Items.mannequin.value:         ItemData(ItemIDs.mannequin.value,         ItemClassification.useful),
  # Noelle royal pin
