...
chapter1_locations = {
  ...
  Chapter1Location.forest_scissor_dancers_chest:          AdvData(LocationIDs.ch1_forest_scissor_dancers_chest,           Ch1Regions.forest),
  Chapter1Location.forest_hidden_chest_near_dancers:      AdvData(LocationIDs.ch1_forest_hidden_chest_near_dancers,       Ch1Regions.forest),
  Chapter1Location.forest_coat_rack_chest:                AdvData(LocationIDs.ch1_forest_coat_rack_chest,                 Ch1Regions.forest),
  Chapter1Location.forest_letter_block_chest:             AdvData(LocationIDs.ch1_forest_letter_block_chest,              Ch1Regions.forest),
  Chapter1Location.forest_chest_near_worm:                AdvData(LocationIDs.ch1_forest_chest_near_worm,                 Ch1Regions.forest),
  Chapter1Location.forest_man:                            AdvData(LocationIDs.ch1_forest_man,                             Ch1Regions.forest),
