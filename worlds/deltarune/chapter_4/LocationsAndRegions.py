...
chapter4_locations = {
  ...
  Ch4Locations.dark_sanctuary_jackenstein_gift.value:           LocationData(LocationIDs.ch4_dark_sanctuary_jackenstein_gift.value,           Ch4Regions.dark_sanctuary),
  Ch4Locations.dark_sanctuary_climbing_tutorial_chest.value:    LocationData(LocationIDs.ch4_dark_santuary_climbing_tutorial_chest.value,     Ch4Regions.dark_sanctuary),
  Ch4Locations.dark_sanctuary_cuptain_pillar_chest.value:       LocationData(LocationIDs.ch4_dark_sanctuary_cuptain_pillar_chest.value,       Ch4Regions.dark_sanctuary),
  Ch4Locations.dark_sanctuary_sleeping_mizzle_chest.value:      LocationData(LocationIDs.ch4_dark_sanctuary_sleeping_mizzle_chest.value,      Ch4Regions.dark_sanctuary),
