...
cross_chapter_conditional_locations: dict = {
  CCLocations.castle_town_ddburger_fusion.value:      ConditionalLocationData(LocationIDs.cc_castle_town_dd_burger_fusion,    CCRegions.fusion_access, lambda world: world.can_access_fusion()),
  CCLocations.castle_town_silver_card_fusion.value:   ConditionalLocationData(LocationIDs.cc_castle_town_silver_card_fusion,  CCRegions.fusion_access, lambda world: world.can_access_fusion()),
  ...
  CCLocations.castle_town_twin_ribbon_fusion.value:   ConditionalLocationData(LocationIDs.cc_castle_town_twin_ribbon_fusion,  CCRegions.fusion_access, lambda world: world.can_access_fusion() and world.has_at_least_one_chapter_included([2, 3]) and world.has_at_least_one_chapter_included([1, 2, 3])),
  ...
  CCLocations.castle_town_spike_band_fusion.value:    ConditionalLocationData(LocationIDs.ch2_castle_town_spike_band_fusion,  CCRegions.fusion_access, lambda world: world.can_access_fusion() and world.include_chapter(1) and world.has_at_least_one_chapter_included([2, 4])),
  # Require B.ShotBowtie that is exclusive to chapter 2 and can't be obtained on weird route
  CCLocations.castle_town_tensionbow_fusion.value:    ConditionalLocationData(LocationIDs.cc_castle_town_tension_bow_fusion,  CCRegions.fusion_access, lambda world: world.can_access_fusion() and world.include_chapter(2) and not world.is_weird_route()),
}
  
cross_chapter_regions = [
  (CCRegions.menu.value, [CCRegions.new_game.value]),
  (CCRegions.hub.value, [
                              CCEntrances.chapter_1_entrance.value,
                              CCEntrances.chapter_2_entrance.value,
...
cross_chapter_mandatory_connections = [
  ...
  (CCEntrances.chapter_1_entrance.value, Ch1Regions.chapter_1.value),
  (CCEntrances.chapter_2_entrance.value, Ch2Regions.chapter_2.value),
  (fusion_access_entrance, fusion_access_region)
]
